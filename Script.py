...
ʏᴏᴜ ʜᴀᴠᴇ ᴛᴏ ᴊᴏɪɴ ᴏᴜʀ ᴏғғɪᴄɪᴀʟ ᴄʜᴀɴɴᴇʟ.
...
USE 👉🏻 @THEATRE_MOVIE_BOT For Theatre Print / New Relese Movies !
    ...
    <blockquote>Cʜᴇᴄᴋ Oɴ Tʜɪꜱ Bᴏᴛ :👉🏻 @THEATRE_MOVIE_BOT</blockquote></b>"""
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/Developer_DM_Bot'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
--------------Verify On Off------------
/verifyoff {{verify.off code}} - off verification <a href="https://t.me/Developer_DM_Bot ">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ ᴄᴏᴅᴇ
...
Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴜsᴇ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs😇</b>"""
    ...
    SOURCE_TXT = """<b>
NOTE:
Tʜɪꜱ ɪꜱ ᴀɴ ᴜᴘɢʀᴀᴅᴇᴅ ʀᴇᴘᴏ ꜱᴏ ɪᴛ ɪꜱ ᴘʀɪᴠᴀᴛᴇ !
    
Iғ Yᴏᴜ Wᴀɴᴛ Tʜᴇɴ Mᴇꜱꜱᴀɢᴇ Tᴏ @Developer_DM_Bot & Bᴜʏ Iᴛ !</b>""" 
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="https://t.me/Developer_DM_Bot">ᴄᴏɴᴛᴀᴄᴛ</a></b>"""
